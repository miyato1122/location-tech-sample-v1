...
**Tests**: Test tasks are REQUIRED. For each user story, write failing tests first,
then implement and add regression tests for bug-prone behavior.
...
- [ ] T004 [P] Configure automated test execution in local and CI workflows
- [ ] T005 Define and document merge-blocking quality gate commands
...
- [ ] TXXX [P] 日本語ドキュメント整備と用語統一
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Add/refresh regression tests in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Run and capture all quality gate commands before merge
